...
2. If you had the three following models, which one would you choose?
    ...
    - Runtime 9 sec	
    - Memory size 9MB
    </br>***Note:&nbsp;As soon as the runtime is less than 10 seconds you're good. So, you may simply maximize the test accuracy after you made sure the runtime is <10sec.***
</br>
